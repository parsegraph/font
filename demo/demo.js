...
app.get("/", async (req, res) => {
  ...
  write(`<body>`);
  write(
    `<h1>font <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`
  );
  write(
    `<p>This library is available as JavaScript UMD module: <a href='/parsegraph-font.js'>parsegraph-font.js</a></p>`
  );
