...
app.get('/', async (req, res) => {
  ...
  write(`<html>`);
  write(`<head>`);
  write(`<title>font</title>`);
  write(`</head>`);
  write(`<body>`);
  write(`<h1>font <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`);
  write(`<p>This library is available as JavaScript UMD module: <a href='/parsegraph-font.js'>parsegraph-font.js</a></p>`);
...
app.listen(port, () => {
  console.log(`See font build information at http://localhost:${port}`);
});
